...
ENGLISH_DEVANAGARI_DICT: Set[str] = {
    ...
    "चैट", "नोटिफिकेशन", "डाउनलोड", "अपलोड", "स्क्रीन",
    # Transport
    ...
    # Education / work — HIGH FREQUENCY in Hindi conversation
    "स्कूल", "कॉलेज", "यूनिवर्सिटी", "क्लास", "एग्जाम",
    "प्रोफेसर", "टीचर", "स्टूडेंट", "लाइब्रेरी",
    "इंटरव्यू", "जॉब", "इंटर्नशिप", "रिज़्यूमे", "ऑफर",
    "प्रेजेंटेशन", "प्रोजेक्ट", "टास्क", "डेडलाइन", "रिपोर्ट",
    # Entertainment
    ...
    "बजट", "सेलरी", "इनकम", "प्रॉफिट", "लॉस",
    # Common adjectives / nouns (high frequency)
    "डिजिटल", "ऑनलाइन", "ऑफलाइन", "स्मार्ट", "फ्री",
    "प्रीमियम", "स्पेशल", "नॉर्मल", "रेगुलर", "ओरिजिनल",
    "फ्रेश", "क्लीन", "सेफ", "सिंपल", "क्विक", "फास्ट",
    # Problem-solving / process words (very common in conversation)
    "प्रॉब्लम", "सॉल्व", "सॉल्यूशन", "प्रोसेस", "सिस्टम",
    "अपडेट", "सपोर्ट", "फीडबैक", "रिव्यू", "एरर",
    # Communication
    "मेसेज", "कॉल", "वीडियो कॉल", "मीटिंग", "ग्रुप",
}
